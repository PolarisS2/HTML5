...
<main class="form-signin w-100 m-auto">
  <form action="my_info_update_ok.php" method="post">
    ...
    <div class="form-floating">
      <input name="prepassword" value="" type="password" class="form-control" id="floatingPassword" >
      <label for="floatingPassword">기존 비밀번호</label>
    </div>
    <div class="form-floating">
      <input name="afterpassword" value="" type="password" class="form-control" id="floatingPassword" >
